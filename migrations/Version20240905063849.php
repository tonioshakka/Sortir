 ...
 */
final class Version20240905063849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image DROP image_file, CHANGE image_name image_name VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD image_file VARCHAR(255) NOT NULL, CHANGE image_name image_name VARCHAR(255) NOT NULL');
    }
}
